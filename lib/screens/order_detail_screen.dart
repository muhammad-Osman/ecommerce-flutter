                ...
                if (index == cartList.length) {
                  return Container(
                    ...
                    margin: EdgeInsets.only(
                        left: index == 0 ? 15.w : 0, right: 10.w),
                    decoration: BoxDecoration(
                        color: kYellow,
                        borderRadius: BorderRadius.circular(20.h)),
                    child:
                        Center(child: CustomText('See all', fontSize: 12.sp)),
                  );
                } else {
                  return Hero(
                    ...
                    child: Container(
                      ...
                      padding: EdgeInsets.all(7.r),
                      margin: EdgeInsets.only(
                          left: index == 0 ? 20.w : 0, right: 10.w),
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(
                          ...
                          bottomRight:
                              Radius.circular(index % 2 != 0 ? 0.r : 20.r),
                        ),
                      ),
